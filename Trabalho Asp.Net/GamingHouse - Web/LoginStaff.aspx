<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginStaff.aspx.cs" Inherits="Login_Funcionários" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <nav class="nav nav-tabs" style="background: #181717">
                ...
                <li><a href="#"><font color="white">Loja</font></a></li>
                <script type="text/javascript">
                    function getSession() {
                        ...
                        if (getSession() == 1) {
                            ...
                            document.write('<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><font color="white">Cadastro</font></a> <ul class="dropdown-menu"> <li><a href="#">Clientes</a></li><li><a href="#">Funcionários</a></li> <li><a href="#">Produtos</a></li></ul></li>');
                            document.write('<li><a href="#" ><font color= "white">Gerenciamento</font></a></li>');
                            document.write('<li><a href="#" ><font color= "white">Logout</font></a></li>');
                        } else if (getSession() == 2) {
                            document.write('<li><a href="#" ><font color= "white">Vendas</font></a></li>');
                            document.write('<li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"> <font color= "white">Cadastro </font></a> <ul class="dropdown-menu"> <li><a href="#">Clientes</a></li><li><a href="#">Produtos</a></li></ul></li>');
                            document.write('<li><a href="#" ><font color= "white">Gerenciamento</font></a></li>');
                            document.write('<li><a href="#" ><font color= "white">Logout</font></a></li>');
